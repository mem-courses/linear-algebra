...
否则，当 $lambda in.not {-2,-1,0,1}$ 时，原线性方程组有通解
$
  cases(
...
#prob[
  ...
  $
    cases(
      ...
      3x_1 + 5x_2 + 10x_3 + 7x_4 &= 5,
      x_1 - 3x_2 - a x_3 + 9x_4 &= 1,
      2x_1 - 3x_2 - 6x_3 + 14x_4 &= b,
    )
  $
]
...
mat(
  ...
  1,-3,-a,9,1;
  2,-3,-6,14,b;
) dxarrow(R_2 - 3R_1 \ R_3 - R_1 \ R_4 - 2R_1) mat(
  1,2,4,2,2;
  0,-1,-2,1,-1;
  0,-5,-a-4,7,-1;
  0,-7,-14,10,b-4;
) dxarrow(-R_2 \ -R_3 \ -R_4) \ mat(
  1,2,4,2,2;
  0,1,2,-1,1;
  0,5,a+4,-7,1;
  0,7,14,-10,-b+4;
) dxarrow(R_3-5R_1 \ R_4-7R_1) mat(
  1,2,4,2,2;
  0,1,2,-1,1;
  0,0,a-6,-2,-4;
  0,0,0,-3,-b-3;
...
- 若 $x_4 != 2$ 即 $b!=3$，则原方程无解；
- 若 $x_4 = 2$ 即 $b=3$，则原方程有无数解：
$
  cases(
    x_1 = -8,
    x_2 = 3-2t,
...
$
cases(
  x_1 = display(-(4a b+12a-24b-72)/(3a-18)),
  x_2 = display((a b+6a-10b-24)/(3a-18)),
  x_3 = display((2b-6)/(3a-18)),
  x_4 = display((b+3)/3),
)
$
...
其中 $r<=m<n$．那么必存在 $i in (r,n] sect ZZ$．令 $x_i$ 取非零常数并代入．得到新的线性方程组有 $r=n$．由定理可知此时必有唯一解．

且由于 $exists r<i<=n "st." x_i != 0$，这组解是非零解．即原线性方程组必有非零解．
